                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:tag, field:'id')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:tag, field:'name')}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">Art Entities:</td>
                            
                            <td valign="top" class="value">${fieldValue(bean:tag, field:'artEntities')}</td>
