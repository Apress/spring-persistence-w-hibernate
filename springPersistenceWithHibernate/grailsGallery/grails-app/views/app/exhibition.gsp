...
<html>
  <head><title>Exhibition ${exhibition?.name}</title></head>
  <body>


  <div id="intgallery">
    <div class="breadcrumb"><a href="${createLink(action: "viewExhibitionMenu", controller: "app")}">Galleries:</a> ${exhibition?.name}</div>
    <div class="clear">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center" valign="top">
                 ...
                 <a href="${createLink(action: "renderImage", controller: "app", id: selectedArt?.id)}" rel="lightbox[${exhibition?.name}]" title="${selectedArt?.title}">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="4">
            <tr>
              <td align="center" valign="top">
                  ...
                  <a href="${createLink(action: "viewExhibition", controller: "app", id: exhibition?.id, params: [artEntityId: previousId])}">
              ...
              <td align="center" valign="top">
                 <g:if test="${existsNext}">
                  <a href="${createLink(action: "viewExhibition", controller: "app", id: exhibition?.id, params: [artEntityId: nextId])}">
    ...
    <div class="gallthumbs">
      <div class="thumbscontent">
        ...
        <g:each in="${artEntities}" var="curEntity">
          <a href="${createLink(action: "viewExhibition", controller: "app", id: exhibition?.id, params: [artEntityId: curEntity?.id])}">
            ...
            <a href="${createLink(action: "renderImage", controller: "app", id: curEntity?.id)}" rel="lightbox[${exhibition?.name}]" title="${curEntity?.title}">
            </a>
